      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="text-center shadow-soft">
          <CardContent className="pt-6">
            <div className="text-2xl font-bold text-plant-growth">${user.donated_amount}</div>
        ...
        <Card className="text-center shadow-soft">
          <CardContent className="pt-6">
            <div className="text-2xl font-bold text-earth">{user.inventory.plants.length}</div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-muted-foreground">150 XP to next level</p>
              </div>
            </div>
            <div className="w-full bg-muted rounded-full h-3">
              <div className="bg-gradient-growth h-3 rounded-full" style={{ width: '85%' }}></div>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="shadow-soft">
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              { date: "2024-01-15", action: "Donated $25 to Sunnydale Elementary", xp: 25 },
